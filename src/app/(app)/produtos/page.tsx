...
function ProdutoForm({ onSuccess, initialData }: { onSuccess: () => void, initialData?: Produto | null }) {
  ...
  const form = useForm<TProdutoSchema>({
    ...
    defaultValues: initialData || { codigo: '', nome: '', precoCusto: 0, precoVenda: 0, estoque: 0, tipo: undefined },
  });

  useEffect(() => {
    form.reset(initialData || { codigo: '', nome: '', precoCusto: 0, precoVenda: 0, estoque: 0, tipo: undefined });
  }, [initialData, form]);
